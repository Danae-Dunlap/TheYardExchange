                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-base text-muted-foreground whitespace-pre-line">{business.hours_of_operation}</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-base text-muted-foreground"> {business.price_range[0]}-{business.price_range[1]}</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
